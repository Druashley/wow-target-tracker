...
const setReminders = () => {
    ...
    if (reminder == 'lucifron') {lucifronBoss.setReminder()};
    if (reminder == "magmadar") {magmadarBoss.setReminder()};
    if (reminder == 'gehennas') {gehennasBoss.setReminder()};
    if (reminder == 'garr') {garrBoss.setReminder()};
    if (reminder == 'baronGeddon') {baronGeddonBoss.setReminder()};
    if (reminder == 'shazzrah') {shazzrahBoss.setReminder()};
    if (reminder == 'sulfuronHarbinger') {sulfuronHarbingerBoss.setReminder()};
    if (reminder == 'golemagg') {golemaggBoss.setReminder()};
    if (reminder == 'majordomo') {majordomoBoss.setReminder()};
    if (reminder == 'ragnaros') {ragnarosBoss.setReminder()};
